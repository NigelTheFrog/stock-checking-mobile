...
export default function AddTemuanAvalan({ route, navigation }) {
  ...
  useEffect(() => {
    ...
    ProcessController.setData('grade-list?statusitem=TA', "gradecode", "description", setGradeData, 0, setGrade);
  }, []);
